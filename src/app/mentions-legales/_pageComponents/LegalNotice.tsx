            ...
            <div className={ classes.subRoot }>
                ...
                <article className={ classes.mainArticle }>
                    ...
                    <div className={ classes.textRoot }>
                        ...
                        <p className={ classes.textParagraph }>{ `Le site ` }<a href={ `https://ad-cam.fr/` } className={ classes.textLink }>{ `https://ad-cam.fr/` }</a>{ ` contient un certain nombre de liens hypertextes vers d’autres sites, mis en place avec l’autorisation de AD CAM. Cependant, AD CAM n’a pas la possibilité de vérifier le contenu des sites ainsi visités, et n’assumera en conséquence aucune responsabilité de ce fait.` }</p>

                        <p className={ classes.textParagraph }>{ `La navigation sur le site ` }<a href={ `https://ad-cam.fr/` } className={ classes.textLink }>{ `https://ad-cam.fr/` }</a>{ ` est susceptible de provoquer l’installation de cookie(s) sur l’ordinateur de l’utilisateur. Un cookie est un fichier de petite taille, qui ne permet pas l’identification de l’utilisateur, mais qui enregistre des informations relatives à la navigation d’un ordinateur sur un site. Les données ainsi obtenues visent à faciliter la navigation ultérieure sur le site, et ont également vocation à permettre diverses mesures de fréquentation.` }</p>
                        ...
                        <p className={ classes.textParagraph }>{ `Tout litige en relation avec l’utilisation du site ` }<a href={ `https://ad-cam.fr/` } className={ classes.textLink }>{ `https://ad-cam.fr/` }</a>{ ` est soumis au droit français. Il est fait attribution exclusive de juridiction aux tribunaux compétents d’ Orléans.` }</p>
