...
function Tile({ image, isFirst, isImageUnder, isVideo, isDark, title, body, bodySize }:TileInterface) {
      ...
      return (
            ...
            >
                  ...
                  >
                        <h3 style={{ fontSize: "20px", textAlign: "center", margin:"0", color: isDark ? "#ADADAD" : "#181818" }}>{ `${title}` }</h3>
                        {
