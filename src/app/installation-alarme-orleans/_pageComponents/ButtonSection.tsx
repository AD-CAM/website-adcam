...
const keypadTechSheetsList = require("../_pageData/keypadTechSheetsList.json")
/* Assets Imports */
...
/* Components Imports */
import { TechSheetBanner, TechSheetList, TechSheetTileContainer } from '@/app/_components/TechSheet'
...
export default function ButtonSection() {
    ...
    return (
        <section className={ classes.root }>
            ...
            <div className={ classes.subRoot }>
                {
                    keypadTechSheetsList.map((techSheetData: TechSheetData, index: number) => {
                        return <TechSheetList
                                            key={ index }
                                            image={ techSheetData.image }
                                            alt={ techSheetData.alt }
